public class Main {
    ...
    public static void main(String[] args){
        ...
        Loja natura = new Cosmetico("Natura", 20, 2550, end1, data1, 0.5, 10);
...
//        botc.removeProduto("batom");
        ...
        borbom.insereLoja(natura);
        borbom.insereLoja(compumaq);
        borbom.insereLoja(infovale);

        System.out.println(borbom.lojaSeguroMaisCaro());

        System.out.println(borbom.quantidadeLojasPorTipo("Cosmetico"));
    ...
    public static void teste(String[] args){
        ...
        Informatica maisCaro = (Informatica) shopping.lojaSeguroMaisCaro();
